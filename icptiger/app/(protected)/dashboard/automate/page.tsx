...
export default function LinkedInAutomationPage() {
  ...
  // If not connected, show the main dashboard with login prompt
  if (hasCredentials === false && !isLoading && !isDemo) {
    console.log("🔗 Rendering dashboard with LinkedIn login prompt");
    return (
          ...
          <div className="bg-white rounded-2xl border border-black/5 p-8 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                To start using LinkedIn automation, you need to connect your LinkedIn account first.
              </p>
              <Button
