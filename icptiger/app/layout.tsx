...
const defaultUrl = process.env.NEXT_PUBLIC_URL || (process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://icptiger.com');
...
export const metadata: Metadata = {
  ...
  description: 'The lean, safe way to automate LinkedIn outreach. Grow your network and generate leads on autopilot while maintaining safety and compliance.',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="min-h-[100svh] flex flex-col w-full relative">
          {children}
        </div>
      </body>
    </html>
