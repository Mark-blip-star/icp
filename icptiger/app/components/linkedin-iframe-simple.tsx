  ...
  const handleLaunchIframe = () => {
    ...
    setTimeout(() => {
      if (iframeRef.current && !iframeRef.current.contentDocument) {
        ...
        // Try popup approach
        const popup = window.open('https://www.linkedin.com/login', '_blank', 'width=600,height=800,left=100,top=100');
        if (popup) {
    ...
    const handleIframeLoad = () => {
      try {
        ...
        if (!iframe.contentDocument) {
          ...
          setError('LinkedIn login page cannot be loaded in this browser. Please try using a different browser or disable browser extensions.');
          return;
        }
            ...
            <div className="mt-3">
              <button
                onClick={() => {
                  ...
                  const newWindow = window.open('https://www.linkedin.com/login', '_blank', 'width=600,height=800');
                  if (newWindow) {
            ...
            <div className="flex-1 p-4">
              ...
              <iframe
                ...
                onError={() => {
                  ...
                  setError('Failed to load LinkedIn login page. Please check your internet connection and try again.');
                }}
              />
            </div>
