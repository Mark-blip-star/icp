          ...
          <CardContent className="pt-6">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500">
                ...
                <p>
                  InMail Credits: <span className="font-medium text-gray-900">45</span>
                </p>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="email" className="font-riffic-free">
                LinkedIn Email
              </Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="font-riffic-free">
                LinkedIn Password
              </Label>
              <div className="relative">
                <Input
