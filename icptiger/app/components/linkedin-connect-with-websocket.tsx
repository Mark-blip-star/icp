    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Connect LinkedIn Account</h1>
          <p className="text-gray-600">Use interactive browser to log in securely</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manual login with real browser (recommended)</CardDescription>
          </CardHeader>
          <CardContent>
